...
var is$1 = { nullOrUndefined: isNullOrUndefined$1, object: isObject$1, number: isNumber$1, string: isString$1, boolean: isBoolean$1, function: isFunction$1, array: isArray$1, nodeList: isNodeList$1, element: isElement$1, event: isEvent$1, empty: isEmpty$1 };
...
var getConstructor = (e) => null != e ? e.constructor : null;
var instanceOf = (e, t) => Boolean(e && t && e instanceof t);
var isNullOrUndefined = (e) => null == e;
var isObject = (e) => getConstructor(e) === Object;
var isNumber = (e) => getConstructor(e) === Number && !Number.isNaN(e);
var isString = (e) => getConstructor(e) === String;
var isBoolean = (e) => getConstructor(e) === Boolean;
var isFunction = (e) => "function" == typeof e;
var isArray = (e) => Array.isArray(e);
var isWeakMap = (e) => instanceOf(e, WeakMap);
var isNodeList = (e) => instanceOf(e, NodeList);
var isTextNode = (e) => getConstructor(e) === Text;
var isEvent = (e) => instanceOf(e, Event);
var isKeyboardEvent = (e) => instanceOf(e, KeyboardEvent);
var isCue = (e) => instanceOf(e, window.TextTrackCue) || instanceOf(e, window.VTTCue);
var isTrack = (e) => instanceOf(e, TextTrack) || !isNullOrUndefined(e) && isString(e.kind);
var isPromise = (e) => instanceOf(e, Promise) && isFunction(e.then);
var isElement = (e) => null !== e && "object" == typeof e && 1 === e.nodeType && "object" == typeof e.style && "object" == typeof e.ownerDocument;
var isEmpty = (e) => isNullOrUndefined(e) || (isString(e) || isArray(e) || isNodeList(e)) && !e.length || isObject(e) && !Object.keys(e).length;
var isUrl = (e) => {
...
var isIPadOS = "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1;
...
var support = { audio: "canPlayType" in document.createElement("audio"), video: "canPlayType" in document.createElement("video"), check(e, t) {
...
var standardRatios = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce((e, [t, i]) => ({ ...e, [t / i]: [t, i] }), {});
...
var replaceAll = (e = "", t = "", i = "") => e.replace(new RegExp(t.toString().replace(/([.*+?^=!:${}()|[\]/\\])/g, "\\$1"), "g"), i.toString());
var toTitleCase = (e = "") => e.toString().replace(/\w\S*/g, (e2) => e2.charAt(0).toUpperCase() + e2.slice(1).toLowerCase());
...
var getHours = (e) => Math.trunc(e / 60 / 60 % 60, 10);
var getMinutes = (e) => Math.trunc(e / 60 % 60, 10);
var getSeconds = (e) => Math.trunc(e % 60, 10);
...
var Fullscreen = class _Fullscreen {
  constructor(e) {
    _defineProperty$1(this, "onChange", () => {
      ...
      if (this.supported) {
        let e2;
        e2 = this.forceFallback ? "Fallback (forced)" : _Fullscreen.nativeSupported ? "Native" : "Fallback", this.player.debug.log(`${e2} fullscreen enabled`);
      } else
        this.player.debug.log("Fullscreen not supported and fallback disabled");
      toggleClass(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.supported);
    }), _defineProperty$1(this, "enter", () => {
      this.supported && (browser.isIos && this.player.config.fullscreen.iosNative ? this.player.isVimeo ? this.player.embed.requestFullscreen() : this.target.webkitEnterFullscreen() : !_Fullscreen.nativeSupported || this.forceFallback ? this.toggleFallback(true) : this.prefix ? is.empty(this.prefix) || this.target[`${this.prefix}Request${this.property}`]() : this.target.requestFullscreen({ navigationUI: "hide" }));
  ...
  get supported() {
    return [this.player.config.fullscreen.enabled, this.player.isVideo, _Fullscreen.nativeSupported || this.player.config.fullscreen.fallback, !this.player.isYouTube || _Fullscreen.nativeSupported || !browser.isIos || this.player.config.playsinline && !this.player.config.fullscreen.iosNative].every(Boolean);
  }
  get active() {
    if (!this.supported)
      return false;
...
var Plyr = class _Plyr {
  ...
  static setup(e, t = {}) {
    let i = null;
    return is.string(e) ? i = Array.from(document.querySelectorAll(e)) : is.nodeList(e) ? i = Array.from(e) : is.array(e) && (i = e.filter(is.element)), is.empty(i) ? null : i.map((e2) => new _Plyr(e2, t));
  }
};
