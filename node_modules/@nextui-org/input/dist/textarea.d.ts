...
type OmittedInputProps = "isClearButtonFocusVisible" | "isLabelPlaceholder" | "isClearable" | "isTextarea" | "startContent" | "endContent";
type TextareaHeightChangeMeta = {
    rowHeight: number;
};
interface TextAreaProps extends Omit<UseInputProps, OmittedInputProps> {
    /**
