...
class AudioProviderLoader {
  ...
  async load() {
    ...
    return new (await import('./vidstack-8bb3644e.js')).AudioProvider(this.target);
  }
}
...
class VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-1076613b.js')).VideoProvider(this.target, context);
  }
}
...
const _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-61f0b368.js')).HLSProvider(this.target, context);
  }
};
